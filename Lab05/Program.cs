...
namespace Lab05
{
    internal class Program
    {
        ...
        {
            // Step 1: อ่านค่าเริ่มต้น 6 ค่าด้วย TryParse แล้วแสดงสถานะเริ่มเกม
            ...
            // Step 2: ดื่มยา แล้วคำนวณดาเมจ 3 แบบ (ยังไม่โจมตีจริง แค่ดูตัวเลข)
            int potionHeal = 8;
            heroHp += potionHeal;
            ...
            // Step 3: คริติคอลฮิต (ใช้ Random Seed 14)
            ...
            // Step 4: สรุปรายงานสอดแนม (comparison + logical operators)
            ...
            // Step 5: Hero ลงมือจริง แล้วสรุปผล + รางวัล
